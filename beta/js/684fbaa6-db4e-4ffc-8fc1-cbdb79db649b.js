...
const colorPalettes = {
    ...
    3: {
        colors: ['127a14', '0ac419', 'ffd60a', 'ff8700', 'ff0000', 'be0aff', '0066ff', '0020ed'],
        free: false,
        name: 'Intense time'
    },
    4: {
        colors: ['6698e8', '7ad9ff', 'b6e66e', 'f9ff8a', 'ffd670', 'ff9770', 'ff70a6', 'c087e6'],
        free: false,
        name: 'Pastelove'
    },
    5: {
        colors: ['c6baff', 'ffc6ff', 'ffb0df', 'ffd6a5', 'fdffb6', 'caffbf', '9cf7ff', 'a4d3f5'],
        free: false,
        name: 'Light neon'
    },
    6: {
        colors: ['ba118a', 'e0129c', 'fa39b3', 'ff73c9', 'ff99e7', 'ed5fd5', 'd100b5', 'a61797'],
        free: false,
        name: 'All pink',
    },
    7: {
    ...
    methods: {
        validateBannerText() {
            ...
            if (this.bannerValue.length === 0) {
                ...
                this.input_generateText_error = 'Please insert your banner text'
                return false
            } else {
