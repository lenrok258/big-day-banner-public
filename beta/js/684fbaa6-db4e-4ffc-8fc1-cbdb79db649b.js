...
const colorPalettes = {
    ...
    1: {
        colors: ['ff0000', 'ff8700', 'ffd60a', '97e519', '09cd44', '2d8be3', 'be0aff'],
        free: false,
        name: 'Happy birthday 2'
    },
    2: {
        colors: ['ff6b66', 'ff974a', 'ffe900', '8ee3d5', 'ff63b1'],
        free: false,
        name: 'Children Birthday Party',
    },
    3: {
        colors: ['ff63c9', 'cbe305', 'ffdb00', '68c7ec', 'ffb3f0'],
        free: false,
        name: 'Birthday Confetti',
        order: 'FIXED'
    },
    4: {
        colors: ['efb0c9', 'f4c2d7', 'f8dae9', 'b9d6f3', 'a1c9f1'],
        free: false,
        name: 'Baby Shower',
        order: 'FIXED'
    },
    5: {
        colors: ['ffa3d1', 'ff73c9', 'fa39b3', 'e0129c', 'ba118a', 'd100b5', 'a31a8c', '78245c'],
        name: 'All Pink',
        order: 'FIXED',
        free: false
    },
    ...
    7: {
        colors: ['007f5f', '2b9348', '55a630', '80b918', 'aacc00', 'bfd200', 'd4d700', 'eeef20', 'ffff3f'],
        free: false,
        name: 'Spring',
        order: 'FIXED'
    },
    8: {
        colors: ['f3dc08', 'f6a31d', 'f15e28', 'd63f3c', 'c81630', '9e1026', '7a1124'],
        free: false,
        name: 'Autumn',
        order: 'FIXED'
    },
    ...
    92: {
        colors: ['ffbe0b', 'fb5607', 'ff006e', 'c11cad', '8338ec', '3a86ff', '2a40e8', '10bd58'],
        free: false
    },
    93: {
        colors: ['ffd60a', 'ff8700', 'ff0000', 'be0aff', '0066ff', '0020ed', '0ac419', '127a14'],
        free: false
    },
    94: {
        colors: ['ff0000', 'ffa500', 'ffff00', '008000', '0000ff', '4b0082', 'ee82ee'],
        free: false,
        name: 'Intense rainbow',
        order: 'FIXED'
    },
    95: {
        colors: ['7ad9ff', '6698e8', 'c087e6', 'ff70a6', 'ff9770', 'ffd670', 'f6ff54', 'b0e660'],
        free: false
    },


    98: {
        colors: ['5f0f40', '9a031e', 'dd3000', 'fb8b24', 'e36414', '3b52d4', '1c7b47', '1a4f5c'],
        free: false
    },
    99: {
    ...
    910: {
        colors: ['ffdd87', 'f0b851', 'e8910e', 'cc7802', 'eb7323', 'c44800', '963102', '732005'],
        free: false
    },
    911: {
    ...
    914: {
        colors: ['f94144', 'f3722c', 'f8961e', 'f9c74f', '90be6d', '43aa8b', '1f7e7b', '386389'],
        free: false,
        order: 'FIXED'
    }
...
var app = new Vue({
    ...
    mounted: function () {
        ...
        if (inputCode) {
            ...
            if (applyResult === -2) {
                this.showToast("Your code expired")
                localStorage.removeItem('403e433e-5e0e-46bc-995e-fcf2691ffe35');
            }
            if (applyResult === -99) {
                this.showToast("Unexpected error, please contact us to fix it.")
            }
        }
